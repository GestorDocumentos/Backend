...
public class RolServiceImpl implements RolService {
    ...
    @Override
    public Optional<RolDTO> getById(Long id) {
        return rolDAO.findById(id);
    }

    @Override
    public Optional<RolDTO> getByRolType(String rolType) {
        return rolDAO.findByRolType(rolType);
    }

    @Override
    public RolDTO create(RolDTO dto) {
        return rolDAO.save(dto);
    }

    @Override
    public Optional<RolDTO> update(Long id, RolDTO dto) {
        return rolDAO.update(id, dto);
    }

    @Override
    public boolean delete(Long id) {
        return rolDAO.deleteById(id);
    }
