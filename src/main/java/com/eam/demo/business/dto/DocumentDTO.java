...
public class DocumentDTO {
    ...
    @Schema(description = "Tipo del documento", example = "ACTA", requiredMode = Schema.RequiredMode.REQUIRED, maxLength = 100)
    private String tipo;

    @Schema(description = "Fecha del documento", example = "2026-04-12", requiredMode = Schema.RequiredMode.REQUIRED)
    private LocalDate fecha;

    @Schema(description = "Estado del documento", example = "PENDING", requiredMode = Schema.RequiredMode.REQUIRED)
